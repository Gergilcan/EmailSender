...
[TestClass]
public class EmailSender_IntegrationTests_BDD_MSTestAssemblyHooks
{
    [AssemblyInitialize]
    [MethodImpl(MethodImplOptions.NoInlining)]
    public static void AssemblyInitialize(TestContext testContext)
    {
        var currentAssembly = typeof(EmailSender_IntegrationTests_BDD_MSTestAssemblyHooks).Assembly;
